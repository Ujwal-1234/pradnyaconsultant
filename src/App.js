    ...
    <>
      <section id='home' className='flex flex-wrap z-50 items-center justify-center h-auto lg:h-screen bg-fixed bg-center bg-cover'>
        ...
        <div className=' z-0 w-3/4 text-xl text-center lg:text-4xl text-black'>
          <span className='font-bold block text-4xl lg:text-6xl'>Welcome to <span className=''> Pradnya Consultant</span> </span>
          Shaping Tomorrow's Technology with Innovation
        </div>
      </section>
      <section id="services"  className=' bg-gradient-to-l  flex flex-wrap items-center justify-center h-auto  mb-12 bg-fixed bg-center bg-cover'>
        <div className='flex lg:mt-14 flex-wrap items-center justify-center'>
          ...
          <div className='border md:w-72 w-full lg:w-72 h-80 m-4 p-4 rounded-2xl justify-center items-center shadow-inner flex flex-wrap shadow-black hover:cursor-pointer card custom-img-3'>
            <span className='bg-white font-bold block p-2 rounded-2xl text-2xl'>Embedded Systems Development</span>
          ...
          <div className='border md:w-72 w-full lg:w-72 h-80 m-4 p-4 rounded-2xl justify-center items-center shadow-inner flex flex-wrap shadow-black hover:cursor-pointer card custom-img-2'>
            <span className='bg-white font-bold block p-2 rounded-2xl text-2xl'>AI Products</span>
            <span className='bg-white p-2 rounded-2xl mt-4 block bg-opacity-90 font-bold'>
          ...
          <div className='border md:w-72 w-full lg:w-72 h-80 m-4 p-4 rounded-2xl justify-center items-center shadow-inner flex flex-wrap shadow-black hover:cursor-pointer card custom-img'>
            <span className='bg-white font-bold block p-2 rounded-2xl text-2xl'>PCB Designs</span>
            <span className='bg-white p-2 rounded-2xl mt-4 block bg-opacity-90 font-bold'>
              Mastering precision in PCB design
            </span>
          </div>
          <div className='border md:w-72 w-full lg:w-72 h-80 m-4 p-4 rounded-2xl justify-center items-center shadow-inner flex flex-wrap shadow-black hover:cursor-pointer card custom-img-2'>
            <span className='bg-white font-bold block p-2 rounded-2xl text-2xl'>Energy Management</span>
            <span className='bg-white p-2 rounded-2xl mt-4 block bg-opacity-90 font-bold'>
              Empowering energy efficiency and cost savings
            </span>
          </div>
          <div className='border md:w-72 w-full lg:w-72 h-80 m-4 p-4 rounded-2xl justify-center items-center shadow-inner flex flex-wrap shadow-black hover:cursor-pointer card custom-img-2'>
            <span className='bg-white font-bold block p-2 rounded-2xl text-2xl'>Power Factor Controller</span>
            <span className='bg-white p-2 rounded-2xl mt-4 block bg-opacity-90 font-bold'>
              Optimizing power factor for energy efficiency
            </span>
          </div>
          <div className='border md:w-72 w-full lg:w-72 h-80 m-4 p-4 rounded-2xl justify-center items-center shadow-inner flex flex-wrap shadow-black hover:cursor-pointer card custom-img-2'>
            <span className='bg-white font-bold block p-2 rounded-2xl text-2xl'>Energizing Communities: Clean Solutions</span>
            <span className='bg-white p-2 rounded-2xl mt-4 block bg-opacity-90 font-bold'>
                <li className='block'>- Distribution of Cooking Stoves and Portable Biogas</li>
                <li className='block'>- Trained and Certified Associates</li>
                <li className='block'>- Training and Knowledge Sharing</li>
                <li className='block'>- Community Transformation</li>
            </span>
          </div>
        </div>
      
      </section>
      <section id="projects"  className='flex flex-wrap items-center justify-center lg:h-screen h-auto mb-12 bg-fixed bg-center bg-cover custom-img'>
